...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{route('reservations.create')}}" class="btn btn-primary waves-effect waves-light ">Nuevo Registro</a>
                <br> <br>
                        ...
                        @foreach ($reservations as $reservation )
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($reservation->reservation_status == 'cancelada')
                                        <button class="btn btn-warning btn-sm" disabled>Editar</i></button>
                                        <button class="btn btn-danger btn-sm" disabled>Cancelar</i></button>
                                    @else
                                        <a href="{{route('reservations.edit', $reservation->id)}}" class="btn btn-warning btn-sm"><i class="ri-edit-line">Editar</i></a>
                                        
                                        <button type="button" class="btn btn-danger btn-sm btn-cancel" data-id="{{$reservation->id}}"><i class="ri-delete-bin-line">Cancelar</i></button>
                                    @endif
                                    <a href="{{route('reservations.show', $reservation->id)}}" class="btn btn-info btn-sm"><i class="ri-eye-line"> Ver</i></a>
                                </td>
                            </tr>
